...
QBOConnector.prototype.put = function put(url, data) {
  logger.info('inside hoist-connector-qbo.put');
  return this.request('PUT', url, data);
};

QBOConnector.prototype.post = function post(url, data) {
...
QBOConnector.prototype.request = function request(method, path, data) {
  ...
  return this.auth._performSecureRequestAsync(this.settings.accessKey, this.settings.accessSecret, method, this.getRootUrl() + path, null, data, contentType, {
